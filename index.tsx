...
// Use environment variable for API key, fallback to prompt if not set
const apiKey = import.meta.env.VITE_GEMINI_API_KEY || window.prompt("Please enter your Google GenAI API key:");
